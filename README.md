...
TLDR: check out the three notebooks below for the Data Wrangling and two predictive models I trained:<br>
...
### [Data Wrangling & EDA](https://github.com/mateomartinez510/Eluvio/blob/main/Eluvio_Challenge_Data_Wrangling_EDA.ipynb)
